...
----
 <plugin>
  ...
  <configuration>
    ...
    <pluginArtifact>io.vertx:protoc-gen-grpc-java:1.1.2-SNAPSHOT:${os.detected.classifier}</pluginArtifact>
  </configuration>
  <executions>
    <execution>
      <id>compile</id>
...
protobuf {
  ...
  plugins {
  grpc {
    artifact = "io.vertx:protoc-gen-grpc-java:1.1.2-SNAPSHOT"
  }
}
  generateProtoTasks {
    all()*.plugins {
