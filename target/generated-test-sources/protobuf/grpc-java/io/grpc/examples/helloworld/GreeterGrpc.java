...
public class GreeterGrpc {
  ...
  public static final class GreeterVertxStub extends io.grpc.stub.AbstractStub<GreeterVertxStub> {
     ...
     */
    public void sayHello(io.grpc.examples.helloworld.HelloRequest request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<io.grpc.examples.helloworld.HelloReply>> response) {
      asyncUnaryCall(
  ...
  private static class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((io.grpc.examples.helloworld.HelloRequest) request,
              (io.vertx.core.Future<io.grpc.examples.helloworld.HelloReply>) io.vertx.core.Future.<io.grpc.examples.helloworld.HelloReply>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.HelloReply>) responseObserver).onNext(ar.result());
